...
**Leaderboard** is a simple webpage that creates a list of people with there score in game.
...
- [Live Demo Link](https://al-amin-khan-shakil.github.io/Leaderboard/)
...
```sh
  cd my-folder
  git clone git@github.com:Al-Amin-Khan-Shakil/Leaderboard.git
```
...
Feel free to check the [issues page](https://github.com/Al-Amin-Khan-Shakil/Leaderboard/issues).
